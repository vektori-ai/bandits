...
from tracegym.contracts import ToolClass
from tracegym.fidelity.replay import tool_classes_from_surface
from tracegym.ingest import load_corpus_and_registry
from tracegym.rl import EnvSpec, StepResult, TaskSuite, TraceEnv, make_env
from tracegym.rl.episode import EpisodeNotStartedError
from tracegym.rl.spec import digest_of
...
def test_cheating_episode_scores_zero(golden_env):
    ...
    what ``tracegym/env/interface.py``'s boundary rule exists to make detectable.
...
def test_spec_tool_schemas_come_from_the_declared_registry(golden_env):
    ...
    assert refund.parameters["x-tracegym-source"] == "declared"
