...
recovery heuristics are needed here -- contrast :mod:`tracegym.ingest.chat_json`.
...
from tracegym.ingest.errors import infer_error_kind
...
#: tracegym-specific attributes carried by the fixture corpus.
ATTR_EPISODE_ID = "tracegym.episode_id"
ATTR_OUTCOME = "tracegym.outcome"
...
def parse_otlp_record(
    ...
    *,
    ...
    ``tracegym.episode_id`` when present, falling back to the OTLP ``traceId`` --
