...
Stage 1 (`tracegym.ingest`) is built in parallel and this module must not depend
...
def _load_make_corpus() -> Any:
    ...
    spec = importlib.util.spec_from_file_location("_tracegym_fixture_make_corpus", path)
