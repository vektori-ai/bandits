"""Stage 6 -- the fidelity gate. Replay a trace against the world rebuilt from it.
    ...
    from tracegym.fidelity import replay_corpus, build_report, render
...
tool below the per-tool floor. See :mod:`tracegym.fidelity.gate` for why both,
:mod:`tracegym.fidelity.compare` for exactly which differences are tolerated,
and :mod:`tracegym.fidelity.replay` for how unsupported tools and external
tools are treated.
"""
