"""Tests for the ``tracegym`` command line.
...
from tracegym.cli import FidelityBundle, TaskBundle, VerifierBundle, app
from tracegym.contracts import StateSchema, ToolSurface, TraceCorpus
...
def ran(tmp_path_factory):
    """One full ``tracegym run`` over the golden corpus, shared by the tests below."""
