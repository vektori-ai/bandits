...
:mod:`tracegym.task.prestate` could prove from reads before the first write. The
...
from tracegym.contracts import JsonObject, StateSchema, TaskCase, Trace, TraceCorpus
from tracegym.task.prestate import PreState, reconstruct_pre_state
