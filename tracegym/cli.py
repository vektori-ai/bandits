"""``tracegym`` -- the command line that runs the whole loop.

    tracegym ingest   traces.otlp.jsonl --source otlp --tools tools.json -o corpus.json
    tracegym surface  corpus.json                                        -o surface.json
    tracegym schema   corpus.json surface.json                           -o schema.json
    tracegym tasks    corpus.json schema.json                            -o tasks.json
    tracegym verify   tasks.json corpus.json schema.json                 -o verifiers.json
    tracegym fidelity corpus.json schema.json tasks.json                 -o fidelity.json
    tracegym run      traces.otlp.jsonl --source otlp --tools tools.json -o out/
...
from tracegym.ingest import CANONICAL_SOURCES, load_corpus_and_registry
