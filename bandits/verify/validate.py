...
def validate_draft(
    ...
    *,
    ...
    if verdicts and not (set(verdicts) & family_traces):
        ...
        raise ValueError(
            f"no adjudicated label in {label_set_id} references a trace in family "
            f"{draft.family_id}; nothing would be measured"
        )
